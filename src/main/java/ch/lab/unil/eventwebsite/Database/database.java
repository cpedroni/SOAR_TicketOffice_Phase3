...
public class database {
    ...
    public database(){
        ...
        eventList.add(new Event("Avengers: Infinity War",
                "https://www.homewallmurals.co.uk/ekmps/shops/allwallpapers/images/avengers-infinity-war-61x91-5cm-movie-poster-31650-1-p.jpg",new Date(),"Pathé Flon",
                "As the Avengers and their allies have continued to protect the world from threats too large for any one hero to handle, a new danger has emerged from the cosmic shadows: Thanos. A despot of intergalactic infamy, his goal is to collect all six Infinity Stones, artifacts of unimaginable power, and use them to inflict his twisted will on all of reality. Everything the Avengers have fought for has led up to this moment, the fate of Earth and existence has never been more uncertain.",
                85.0,200,"Covid Certificate , Mask","Selling"));
        
        eventList.add(new Event("Dune",
                "https://www.homewallmurals.co.uk/ekmps/shops/allwallpapers/images/avengers-infinity-war-61x91-5cm-movie-poster-31650-1-p.jpg",new Date(),
                "Capitole Lausanne",
                "A mythic and emotionally charged hero's journey, \"Dune\" tells the story of Paul Atreides, a brilliant and gifted young man born into a great destiny beyond his understanding, who must travel to the most dangerous planet in the universe to ensure the future of his family and his people. As malevolent forces explode into conflict over the planet's exclusive supply of the most precious resource in existence-a commodity capable of unlocking humanity's greatest potential-only those who can conquer their fear will survive.",
                23.0,3, "Covid Certificate,Mask ,ID Card","Selling" ));
        
        eventList.add(new Event("No Time to Die",
                "https://www.homewallmurals.co.uk/ekmps/shops/allwallpapers/images/avengers-infinity-war-61x91-5cm-movie-poster-31650-1-p.jpg",new Date(),
                "Casino Martigny",
                "Bond has left active service and is enjoying a tranquil life in Jamaica. His peace is short-lived when his old friend Felix Leiter from the CIA turns up asking for help. The mission to rescue a kidnapped scientist turns out to be far more treacherous than expected, leading Bond onto the trail of a mysterious villain armed with dangerous new technology.",
                50.0,200,"Covid Certificate,Mask ,ID Card,No Food","Sold out" ));
       ...
       eventList.add(new Event("Shang-Chi and the Legend of the Ten Rings",
               ...
               10.0,10000,"Covid Certificate,Mask ,ID Card,No Food","To come" ));
      ...
      eventList.add(new Event("Spider-Man : No Way Home",
              ...
              25.0,1300,"Covid Certificate,Mask ,ID Card,No Food","Selling"));
    ...
    eventList.add(new Event("The French Dispatch",
            ...
            20.0,50,"Covid Certificate,Mask ,ID Card,No Food","To come"));
     ...
     eventList.add(new Event("Ghostbusters : Afterlife",
             ...
             50.0,1000,"Covid Certificate,Mask no Obligatory ,ID Card,No Food","To come"));
     
     eventList.add(new Event("House of Gucci",
             "https://www.homewallmurals.co.uk/ekmps/shops/allwallpapers/images/avengers-infinity-war-61x91-5cm-movie-poster-31650-1-p.jpg",
             new Date(),
             "Rex Aubonne",
             ...
             40.0,300,"Covid Certificate,Mask,ID Card,No Food","To come"));
     ...
     eventList.add(new Event("The suicide squad",
             ...
             20.0,20,"Covid Certificate,Mask no Obligatory ,ID Card","To come"));

     eventList.add(new Event("Belfast",
             "https://www.homewallmurals.co.uk/ekmps/shops/allwallpapers/images/avengers-infinity-war-61x91-5cm-movie-poster-31650-1-p.jpg",
             new Date(),
             "Pathé Flon",
             "A young boy and his working class family experience the tumultuous late 1960s."
             ,20.0,300,"Covid Certificate,ID Card,No Food","Selling"));
     ...
     eventList.add(new Event("Harry Potter and the Sorcerer's Stone",
             ...
             70.0,500,"Covid Certificate,Mask ,ID Card","Selling"));
     ...
     eventList.add(new Event("Spectre",
             ...
             50.0,200,"Covid Certificate,Mask ,ID Card,No Food","To come"));
     ...
     eventList.add(new Event("Cruella",
             ...
             15.0,300,"Covid Certificate,Mask no Obligatory ,ID Card,No Food","Past"));
     ...
     eventList.add(new Event("Interstellar",
             ...
             20.0,2000,"Covid Certificate,Mask  ,ID Card","Selling"));
     ...
     eventList.add(new Event("Home Alone",
             ...
             30.0,1000,"Covid Certificate,Mask no Obligatory ,ID Card,No Food","Past"));
     ...
     eventList.add(new Event("The King",
             ...
             50.0,300,"Covid Certificate,Mask ID Card","To come"));
     ...
     eventList.add(new Event("Blade Runner 2049",
             ...
             10.0,500,"Covid Certificate,Mask no Obligatory ,ID Card,No Food","Sold out"));
     ...
     eventList.add(new Event("Avengers Endgame",
             ...
             10.0,200,"Covid Certificate,Mask ,ID Card,No Food","Past"));
     ...
     eventList.add(new Event("The Matrix Resurrections",
             ...
             20.0,400,"Covid Certificate,Mask ,ID Card ","To come"));
   ...
   public Event getSpecifyEvent(Event e){
    ...
    public ArrayList<Event> getEventInSold() {
        ...
        for(Event event:eventList){
            if(event.getStatus().contains("Past")){ 
    ...
    public ArrayList<Event> getAllAvailableEvent() {
        ...
        for(Event event:eventList){
            if(event.getStatus().contains("Selling") || event.getStatus().contains("To come") )
    ...
    public int  deleteAllExpiredEventObj() {
        ...
        if (!eventList.isEmpty()){
            for (Event e : eventList){
                     if(e.getStatus().contains("Canceled")){
                         eventList.remove(e);
                         count++;
                     }     
            }
    ...
    public ArrayList<Event> searchElement(String s){
        ArrayList<Event> result = new ArrayList<>();
        for(Event e : eventList){
            if(e.getName().contains(s) || e.getLocation().contains(s)|| e.getDescription().contains(s))
                result.add(e);
        }
        return result;
    }
